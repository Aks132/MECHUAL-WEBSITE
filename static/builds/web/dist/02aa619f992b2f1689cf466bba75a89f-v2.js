(self.webpackChunksketchfab = self.webpackChunksketchfab || []).push([
    [9375], {
        R4My: (t, e, i) => {
            var n, s, r;
            r = "object" == typeof self && self.self === self && self || "object" == typeof global && global.global === global && global, n = [i("h77i"), i("Hjnd"), e], s = function(t, e, i) {
                r.Backbone = function(t, e, i, n) {
                    ...
                    var o, a = e.Events = {},
                        h = /\s+/,
                        l = function(t, e, n, s, r) {
                            var o, a = 0;
                            if (n && "object" == typeof n) {
                                void 0 !== s && "context" in r && void 0 === r.context && (r.context = s);
                                for (o = i.keys(n); a < o.length; a++) e = l(t, e, o[a], n[o[a]], r)
                            } else if (n && h.test(n))
                                for (o = n.split(h); a < o.length; a++) e = t(e, o[a], s, r);
                            else e = t(e, n, s, r);
                            return e
                        };
                    a.on = function(t, e, i) {
                        return this._events = l(c, this._events || {}, t, e, {
                            context: i,
                            ctx: this,
                            listening: o
                        }), o && ((this._listeners || (this._listeners = {}))[o.id] = o, o.interop = !1), this
                    }, a.listenTo = function(t, e, n) {
                        if (!t) return this;
                        var s = t._listenId || (t._listenId = i.uniqueId("l")),
                            r = this._listeningTo || (this._listeningTo = {}),
                            a = o = r[s];
                        a || (this._listenId || (this._listenId = i.uniqueId("l")), a = o = r[s] = new v(this, t));
                        var h = u(t, e, n, this);
                        if (o = void 0, h) throw h;
                    ...
                    var d = function(t, e, n, s) {
                        if (t) {
                            var r, o = s.context,
                                ...
                                h = 0;
                            if (e || o || n) {
                                for (r = e ? [e] : i.keys(t); h < r.length; h++) {
                                    var l = t[e = r[h]];
                                    if (!l) break;
                                    for (var c = [], u = 0; u < l.length; u++) {
                                        var d = l[u];
                                        if (n && n !== d.callback && n !== d.callback._callback || o && o !== d.context) c.push(d);
                                        else {
                                            var f = d.listening;
                                            f && f.off(e, n)
                                        }
                            ...
                            for (r = i.keys(a); h < r.length; h++) a[r[h]].cleanup()
                        }
                    };
                    a.once = function(t, e, i) {
                        var n = l(f, {}, t, e, this.off.bind(this));
                        return "string" == typeof t && null == i && (e = void 0), this.on(n, e, i)
                    }, a.listenToOnce = function(t, e, i) {
                        var n = l(f, {}, e, i, this.stopListening.bind(this, t));
                    ...
                    a.trigger = function(t) {
                        ...
                        return l(p, this._events, t, void 0, i), this
                    };
                    ...
                    v.prototype.on = a.on, v.prototype.off = function(t, e) {
                        var i;
                        this.interop ? (this._events = l(d, this._events, t, e, {
                            context: void 0,
                            listeners: void 0
                        }), i = !this._events) : (this.count--, i = 0 === this.count), i && this.cleanup()
                    ...
                    i.extend(m.prototype, a, {
                        ...
                        set: function(t, e, n) {
                            ...
                            for (var d in s) e = s[d], i.isEqual(l[d], e) || a.push(d), i.isEqual(u[d], e) ? delete c[d] : c[d] = e, r ? delete l[d] : l[d] = e;
                            if (this.idAttribute in s && (this.id = this.get(this.idAttribute)), !o) {
                                a.length && (this._pending = n);
                                for (var f = 0; f < a.length; f++) this.trigger("change:" + a[f], this, l[a[f]], n)
                            }
                            if (h) return this;
                            if (!o)
                        ...
                        save: function(t, e, n) {
                            ...
                            }, G(this, n), s && r && (this.attributes = i.extend({}, h, s));
                            var l = this.isNew() ? "create" : n.patch ? "patch" : "update";
                            "patch" !== l || n.attrs || (n.attrs = s);
                        ...
                        destroy: function(t) {
                            ...
                            var o = !1;
                            return this.isNew() ? i.defer(t.success) : (G(this, t), o = this.sync("delete", this, t)), s || r(), o
                        },
                        url: function() {
                    ...
                    i.extend(_.prototype, a, {
                        ...
                        remove: function(t, e) {
                            ...
                            return !e.silent && s.length && (e.changes = {
                                ...
                                merged: [],
                                removed: s
                            }, this.trigger("update", this, e)), n ? s[0] : s
                        },
                        set: function(t, e) {
                            if (null != t) {
                                ...
                                for (o = 0; o < t.length; o++) {
                                    ...
                                    if (_) {
                                        if (f && r !== _) {
                                            ...
                                            e.parse && (b = _.parse(b, e)), _.set(b, e), l.push(_), v && !g && (g = _.hasChanged(m))
                                        }
                                        u[_.cid] || (u[_.cid] = !0, a.push(_)), t[o] = _
                                    } else d && (r = t[o] = this._prepareModel(r, e)) && (h.push(r), this._addReference(r, e), u[r.cid] = !0, a.push(r))
                                }
                                if (p) {
                                    for (o = 0; o < this.length; o++) u[(r = this.models[o]).cid] || c.push(r);
                                    c.length && this._removeModels(c, e)
                                }
                                var w = !1,
                                    E = !v && d && p;
                                if (a.length && E ? (w = this.length !== a.length || i.some(this.models, (function(t, e) {
                                        return t !== a[e]
                                    })), this.models.length = 0, x(this.models, a, 0), this.length = this.models.length) : h.length && (v && (g = !0), x(this.models, h, null == s ? this.length : s), this.length = this.models.length), g && this.sort({
                                        silent: !0
                                    }), !e.silent) {
                                    for (o = 0; o < h.length; o++) null != s && (e.index = s + o), (r = h[o]).trigger("add", r, this, e);
                                    (g || w) && this.trigger("sort", this, e), (h.length || c.length || l.length) && (e.changes = {
                                        added: h,
                                        removed: c,
                                        merged: l
                    ...
                    var T = e.View = function(t) {
                            this.cid = i.uniqueId("view"), this.preinitialize.apply(this, arguments), i.extend(this, i.pick(t, P)), this._ensureElement(), this.initialize.apply(this, arguments)
                        },
                        H = /^(\S+)\s*(.*)$/,
                    ...
                    var $ = function(t, e, i, n) {
                            switch (e) {
                                ...
                                case 3:
                                    return function(e, s) {
                                        return t[i](this[n], C(e, this), s)
                                    };
                                case 4:
                                    return function(e, s, r) {
                                        return t[i](this[n], C(e, this), s, r)
                                    };
                                default:
                                    return function() {
                    ...
                    i.each([
                        ...
                        if (s.url || (o.url = i.result(n, "url") || V()), null != s.data || !n || "create" !== t && "update" !== t && "patch" !== t || (o.contentType = "application/json", o.data = JSON.stringify(s.attrs || n.toJSON(s))), s.emulateJSON && (o.contentType = "application/x-www-form-urlencoded", o.data = o.data ? {
                                model: o.data
                    ...
                    i.extend(O.prototype, a, {
                        ...
                        route: function(t, n, s) {
                            ...
                            return e.history.route(t, (function(i) {
                                ...
                                !1 !== r.execute(s, o, n) && (r.trigger.apply(r, ["route:" + n].concat(o)), r.trigger("route", n, o), e.history.trigger("route", r, n, o))
                            })), this
                        },
                        ...
                        _routeToRegExp: function(t) {
                            return t = t.replace(J, "\\$&").replace(U, "(?:$1)?").replace(z, (function(t, e) {
                                return e ? t : "([^/?]+)"
                    ...
                    var D = function(t, e) {
                        ...
                        }, i.extend(n, s, e), n.prototype = i.create(s.prototype, t), n.prototype.constructor = n, n.__super__ = s.prototype, n
                    };
