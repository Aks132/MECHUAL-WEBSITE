/*! For license information please see c5cb6f51e591d2fc0ac43ed0f86fb16e-v2.js.LICENSE.txt */
        ...
        "8SXq": (t, e, i) => {
            ...
            ! function(r, s, o, a) {
                ...
                var X = "ontouchstart" in r,
                    N = R(r, "PointerEvent") !== a,
                    Y = X && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
                    k = "touch",
                    F = "mouse",
                    q = 24,
                    W = ["x", "y"],
                    ...
                    i.isFirst = !!s, i.isFinal = !!o, s && (t.session = {}), i.eventType = e,
                        function(t, e) {
                            ...
                            var s = i.firstInput,
                                ...
                                u = e.center = j(n);
                            e.timeStamp = f(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = $(h, u), e.distance = B(h, u),
                                function(t, e) {
                                    var i = e.center,
                                        n = t.offsetDelta || {},
                                        r = t.prevDelta || {},
                            ...
                            var l, v;
                            var d = t.element;
                            _(e.srcEvent.target, d) && (d = e.srcEvent.target);
                            e.target = d
                ...
                Dt.prototype = {
                    ...
                    preventDefaults: function(t) {
                        ...
                        if (this.manager.session.prevented) e.preventDefault();
                            ...
                            if (!o || !s) return r || s && 6 & i || o && i & q ? this.preventSrc(e) : void 0
                        }
                    },
                ...
                function xt(t) {
                    this.options = h({}, this.defaults, t || {}), this.id = M++, this.manager = null, this.options.enable = b(this.options.enable, !0), this.state = 1, this.simultaneous = {}, this.requireFail = []
                }
                ...
                function Wt(t, e) {
                    return (e = e || {}).recognizers = b(e.recognizers, Wt.defaults.preset), new Lt(t, e)
                }
                xt.prototype = {
                    defaults: {},
                    set: function(t) {
                    ...
                    getTouchAction: function() {
                        var t = this.options.direction,
                            e = [];
                        return 6 & t && e.push(_t), t & q && e.push(St), e
                    },
                    ...
                    attrTest: function(t) {
                        ...
                        return 30 & i ? e = t.overallVelocity : 6 & i ? e = t.overallVelocityX : i & q && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && p(e) > this.options.velocity && 4 & t.eventType
                    },
                    emit: function(t) {
                ...
                function Lt(t, e) {
                    var i;
                    this.options = h({}, Wt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new((i = this).options.inputClass || (N ? st : Y ? ft : X ? dt : tt))(i, U), this.touchAction = new Dt(this, this.options.touchAction), Ht(this, !0), m(this.options.recognizers, (function(t) {
