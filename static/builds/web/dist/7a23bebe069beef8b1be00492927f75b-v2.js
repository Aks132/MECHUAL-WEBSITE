        ...
        "4fae": (t, e, n) => {
            ...
            var f = function() {
                    function t(t, e, n) {
                        ...
                        this._key = t, this._getId = "function" == typeof u ? u : function(t) {
                            return function(e) {
                                return a(e) ? e.get(t) : e[t]
                            }
                        }(u), this._idAttribute = u, this._mergeStrategy = f, this._processStrategy = h, this._fallbackStrategy = y, this.define(e)
                    }
                    var e = t.prototype;
                    return e.define = function(t) {
                        ...
                        var n = this;
                        return a(t) ? c(this.schema, t, e) : (Object.keys(this.schema).forEach((function(r) {
                ...
                s = function() {
                    ...
                    return e.define = function(t) {
                        ...
                        var n = a(t) ? t.get("schema") : t.schema;
                        return this.isSingleSchema || n ? e((this.isSingleSchema ? void 0 : a(t) ? t.get("id") : t.id) || t, this.isSingleSchema ? this.schema : this.schema[n]) : t
                    }, i(t, [{
                        key: "isSingleSchema",
                        get: function() {
                ...
                l = function(t) {
                    ...
                    u(e, t);
                    var n = e.prototype;
                    return n.normalize = function(t, e, n, r, i, u) {
                        var a = this;
                        return Object.keys(t).reduce((function(e, n, c) {
                            var f, s = t[n];
                            return null != s ? o({}, e, ((f = {})[n] = a.normalizeValue(s, t, n, r, i, u), f)) : e
                        }), {})
                    }, n.denormalize = function(t, e) {
                        var n = this;
                        return Object.keys(t).reduce((function(r, i) {
                            var u, a = t[i];
                            return o({}, r, ((u = {})[i] = n.denormalizeValue(a, e), u))
                        }), {})
                    }, e
                }(s),
                y = function(t) {
                ...
                p = function(t, e, n, r, i, o, u) {
                    return t = y(t), m(e).map((function(e, a) {
                        return i(e, n, r, t, o, u)
                    }))
                },
                d = function(t, e, n) {
                    return t = y(t), e && e.map ? e.map((function(e) {
                        return n(e, t)
                    })) : e
                },
                v = function(t) {
                ...
                S = function t(e, n, r, i, o, u) {
                    return "object" == typeof e && e ? "object" != typeof i || i.normalize && "function" == typeof i.normalize ? i.normalize(e, n, r, t, o, u) : (Array.isArray(i) ? p : b)(i, e, n, r, t, o, u) : e
                },
                z = {
                    Array: v,
                    Entity: f,
                ...
                j = function(t) {
                    ...
                    return function t(r, i) {
                        return "object" != typeof i || i.denormalize && "function" == typeof i.denormalize ? null == r ? r : i instanceof f ? function(t, e, n, r, i) {
                            var u = r(t, e);
                            if (void 0 === u && e instanceof f && (u = e.fallback(t, e)), "object" != typeof u || null === u) return u;
                            if (i[e.key] || (i[e.key] = {}), !i[e.key][t]) {
                                var c = a(u) ? u : o({}, u);
                                i[e.key][t] = c, i[e.key][t] = e.denormalize(c, n)
                            }
                            return i[e.key][t]
                        }(r, i, t, n, e) : i.denormalize(r, t) : (Array.isArray(i) ? d : g)(i, r, t)
                    }
                },
                A = function(t) {
                    var e = a(t);
