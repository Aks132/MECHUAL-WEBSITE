    ...
    [3918], {
        K9VK: (e, i, o) => {
            ...
            function w(e) {
                ...
                e || "undefined" == typeof navigator ? "string" == typeof e ? i.userAgent = e : e && e.userAgent && (i = {
                ...
                var o = i.userAgent,
                    w = o.split("[FBAN");
                void 0 !== w[1] && (o = w[0]), void 0 !== (w = o.split("Twitter"))[1] && (o = w[0]);
                var k = function(e) {
                        return function(i) {
                            return i.test(e)
                        }
                    ...
                    A = {
                        apple: {
                            phone: k(t) && !k(s),
                            ipod: k(n),
                            tablet: !k(t) && (k(a) || g(i)) && !k(s),
                            universal: k(r),
                            device: (k(t) || k(n) || k(a) || k(r) || g(i)) && !k(s)
                        },
                        amazon: {
                            phone: k(l),
                            tablet: !k(l) && k(b),
                        ...
                        android: {
                            phone: !k(s) && k(l) || !k(s) && k(d),
                            tablet: !k(s) && !k(l) && !k(d) && (k(b) || k(p)),
                            device: !k(s) && (k(l) || k(b) || k(d) || k(p)) || k(/\bokhttp\b/i)
                        },
                        windows: {
                            phone: k(s),
                            tablet: k(u),
