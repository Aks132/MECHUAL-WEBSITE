/*! For license information please see 49f9c2db2a4daeebc191b8994078df2f-v2.js.LICENSE.txt */
"use strict";
(self.webpackChunksketchfab = self.webpackChunksketchfab || []).push([
    [3655], {
        "OE+t": (e, n) => {
            ...
            function q(e) {
                for (var n = g(F); null !== n;) {
                    if (null === n.callback) x(F);
                    else {
                        if (!(n.startTime <= e)) break;
                        x(F), n.sortIndex = n.expirationTime, T(P, n)
                    }
                    n = g(F)
                }
            }
            ...
            function Y(e, t) {
                ...
                var o = A;
                try {
                    for (q(t), M = g(P); null !== M && (!(M.expirationTime > t) || e && !n.unstable_shouldYield());) {
                        var l = M.callback;
                        if ("function" == typeof l) {
                            M.callback = null, A = M.priorityLevel;
                            var i = l(M.expirationTime <= t);
                            t = n.unstable_now(), "function" == typeof i ? M.callback = i : M === g(P) && x(P), q(t)
                        } else x(P);
                        M = g(P)
                    }
                    if (null !== M) var u = !0;
            ...
            n.unstable_IdlePriority = 5, n.unstable_ImmediatePriority = 1, n.unstable_LowPriority = 4, n.unstable_NormalPriority = 3, n.unstable_Profiling = null, n.unstable_UserBlockingPriority = 2, n.unstable_cancelCallback = function(e) {
                ...
                return e = {
                    ...
                    sortIndex: -1
                }, l > i ? (e.sortIndex = l, T(F, e), null === g(P) && e === g(F) && (L ? a() : L = !0, r(R, l - i))) : (e.sortIndex = u, T(P, e), E || j || (E = !0, t(Y))), e
